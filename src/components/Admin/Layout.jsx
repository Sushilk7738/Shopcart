...
const Layout = ({children})=>{
    ...
    const menus = [
        ...
        {
            label : 'Orders',
            icon : <i class="ri-shopping-bag-3-line mr-2"></i>,
            link : '/admin/orders'
        },
        {
            label:'Payments',
            icon : <i className="ri-refund-2-fill mr-2"></i>,
            link : '/admin/payments'
        },
        {
            label:'Settings',
    ...
    return(
        <>
                            ...
                            />
                                {
                                    ...
                                    <div className="absolute top-18 right-0 bg-white shadow-lg w-[200px] p-6">
                                        <div>
                                            <h1 className="text-lg font-semibold">Sushil kamble</h1>
                                            <p className="text-gray-500">sush@7gmail.com</p>
            ...
            <div className="md:hidden block">
                <aside 
                    className=" bg-indigo-600 fixed top-0 z-50 left-0 h-full overflow-hidden"
                    style={{
                        width:mobileSize,
                        transition:'0.3s'
                    }}
