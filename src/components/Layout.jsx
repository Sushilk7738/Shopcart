        ...
        <div>
            ...
            <footer className="bg-orange-600 py-16">
                <div className="w-10/12 mx-auto grid md:grid-cols-4 md:gap-0 gap-8">
                    ...
                    <div>
                        <h1 className="text-white font-sans font-semibold text-2xl mb-3">Follow us</h1>
                        <ul className="space-y-2 text-slate-50">
                    ...
                    <div className="pr-8">
                        <h1 className="text-white font-sans font-semibold text-2xl mb-3">Brand Details</h1>
                        <p className="text-slate-50 mb-3">Lorem ipsum dolor sit amet consectetur adipisicing elit. Error officia itaque dolorem quo, incidunt voluptate neque modi? Soluta.</p>
                        <img 
                            src="/images/logo.png"
                            className="w-[100px]"
                        />
                    ...
                    <div>
                        <h1 className="text-white font-sans font-semibold text-2xl mb-3">Contact us</h1>
